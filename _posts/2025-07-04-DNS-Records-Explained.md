...
### CNAME Limitations and Cloudflare's CNAME Flattening
...
**Cloudflare's CNAME Flattening:** Cloudflare automatically performs CNAME flattening for apex domains, solving this RFC limitation. Here's how it works:

1. **DNS Query Resolution** - When you create a CNAME at the apex domain through Cloudflare
2. **Recursive Resolution** - Cloudflare's authoritative nameservers perform recursive DNS lookups to resolve the CNAME chain
